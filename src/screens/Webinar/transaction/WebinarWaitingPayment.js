...
import {BankAccounts} from '../components/constants';
import ModalUploadPayment from '../../Marketplace/waiting_payment/components/ModalUploadPayment'
...
export default function WebinarWaitingPayment({route, navigation}) {
    ...
    if (Object.keys(newErrors).length > 0) {
      ...
      axiosInstance
        ...
        //   navigation.push(MarketplaceRouteName.DETAIL_PAYMENT);
          navigation.push(WebinarRouteName.WEBINAR_TICKET_LIST);
        })
        .catch(error => {
  ...
  return (
    <Template scroll={true} url={WebinarRouteName.WEBINAR_WAITING_PAYMENT}>

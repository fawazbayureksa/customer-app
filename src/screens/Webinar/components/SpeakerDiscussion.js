import {
  ...
  export default function SpeakerDiscussion({
    discussText,
    setDiscussText,
    isLoadMore,
    handlePagination,
        ...
        <View
          ...
          <View style={{ flex: 4, }}>
            ...
            <View style={{ marginVertical: 5 }}>
              {item.webinar_speaker_discussion_replies.length > 0 &&
                item.webinar_speaker_discussion_replies.map(reply => {
                  return (
                    <>
                      <View style={{ flexDirection: 'row' }}>
                        ...
                        <View style={{ flex: 20 }}>
                          ...
                          <Text style={{ fontSize: 11 }}>
                            {moment(reply.updated_at).format('YYYY-MM-DD  HH:mm')}
                          </Text>
